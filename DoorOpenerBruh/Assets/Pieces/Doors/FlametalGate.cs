...
public class FlametalGate : DoorPiece
{
    public FlametalGate(string prefabName, string pieceName, string configSection) : base(prefabName, pieceName, configSection)
    {
